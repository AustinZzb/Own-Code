...
public class selectcaigou {
	...
	public selectcaigou(int m,String s) {
		...
		JLabel label_7_1 = new JLabel("采购日期");
		label_7_1.setFont(new Font("楷体", Font.BOLD, 15));
		...
		label_15_1.setFont(new Font("楷体", Font.BOLD, 15));
	...
	// 查询销售记录
		public selectcaigou(int m,String s,int m_1) {
			...
			JLabel lblNewLabel_1 = new JLabel("\u67E5  \u8BE2  销  售  \u8BB0  \u5F55");
			lblNewLabel_1.setFont(new Font("楷体", Font.BOLD, 15));
			lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
			lblNewLabel_1.setBounds(55, 49, 258, 39);
			frame.getContentPane().add(lblNewLabel_1);
			...
			JLabel label_7 = new JLabel("销售\u603B\u989D");
			label_7.setFont(new Font("楷体", Font.BOLD, 15));
			label_7.setBounds(31, 453, 90, 15);
			frame.getContentPane().add(label_7);
			
			JLabel label_7_1 = new JLabel("销售日期");
			label_7_1.setFont(new Font("楷体", Font.BOLD, 15));
			label_7_1.setBounds(31, 490, 90, 15);
			frame.getContentPane().add(label_7_1);
		...
		// 查询库存记录
				public selectcaigou(int m,String s,int m_1,int m_2) {
					...
					JLabel lblNewLabel_1 = new JLabel("\u67E5  \u8BE2  库  存  \u8BB0  \u5F55");
					lblNewLabel_1.setFont(new Font("楷体", Font.BOLD, 15));
					lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
					lblNewLabel_1.setBounds(55, 49, 258, 39);
					frame.getContentPane().add(lblNewLabel_1);
				...
				public selectcaigou(int m,String s,int m_1,int m_2,int m_3,int m_4) {
					...
					JLabel lblNewLabel_1 = new JLabel("\u67E5  \u8BE2  账  款  \u8BB0  \u5F55");
					lblNewLabel_1.setFont(new Font("楷体", Font.BOLD, 15));
					lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
					lblNewLabel_1.setBounds(55, 49, 258, 39);
					frame.getContentPane().add(lblNewLabel_1);
					
					JLabel lblNewLabel_2 = new JLabel("账款编号");
					lblNewLabel_2.setFont(new Font("楷体", Font.BOLD, 15));
					lblNewLabel_2.setBounds(31, 121, 90, 15);
					frame.getContentPane().add(lblNewLabel_2);
					
					JLabel label = new JLabel("进账类型");
					label.setFont(new Font("楷体", Font.BOLD, 15));
					label.setBounds(31, 159, 90, 15);
					frame.getContentPane().add(label);
					...
					JLabel label_2 = new JLabel("负责人ID");
					label_2.setFont(new Font("楷体", Font.BOLD, 15));
					label_2.setBounds(31, 247, 90, 15);
					frame.getContentPane().add(label_2);
					
					JLabel label_3 = new JLabel("图书ID");
					label_3.setFont(new Font("楷体", Font.BOLD, 15));
					label_3.setBounds(31, 290, 90, 15);
					frame.getContentPane().add(label_3);
					
					JLabel label_4 = new JLabel("进销单号");
					label_4.setFont(new Font("楷体", Font.BOLD, 15));
					label_4.setBounds(31, 332, 90, 15);
					frame.getContentPane().add(label_4);
					
					JLabel label_5 = new JLabel("明细");
					label_5.setFont(new Font("楷体", Font.BOLD, 15));
					label_5.setBounds(31, 371, 90, 15);
					frame.getContentPane().add(label_5);
					...
					JLabel label_7 = new JLabel("库存");
					label_7.setFont(new Font("楷体", Font.BOLD, 15));
					label_7.setBounds(31, 453, 90, 15);
					frame.getContentPane().add(label_7);
					
					JLabel label_7_1 = new JLabel("分区");
					label_7_1.setFont(new Font("楷体", Font.BOLD, 15));
				...
				public selectcaigou(int m,String s,int m_1,int m_2,int m_3,int m_4,int m_5) {
					...
					JLabel lblNewLabel_1 = new JLabel("\u67E5  \u8BE2  报  警  \u8BB0  \u5F55");
					lblNewLabel_1.setFont(new Font("楷体", Font.BOLD, 15));
					lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
					lblNewLabel_1.setBounds(55, 49, 258, 39);
					frame.getContentPane().add(lblNewLabel_1);
					
					JLabel lblNewLabel_2 = new JLabel("报警编号");
					lblNewLabel_2.setFont(new Font("楷体", Font.BOLD, 15));
					lblNewLabel_2.setBounds(31, 121, 90, 15);
					frame.getContentPane().add(lblNewLabel_2);
					
					JLabel label = new JLabel("书籍ID");
					label.setFont(new Font("楷体", Font.BOLD, 15));
					...
					JLabel label_2 = new JLabel("报警类型");
					label_2.setFont(new Font("楷体", Font.BOLD, 15));
					label_2.setBounds(31, 263, 90, 15);
					frame.getContentPane().add(label_2);
					
					JLabel label_3 = new JLabel("报警信息");
					label_3.setFont(new Font("楷体", Font.BOLD, 15));
